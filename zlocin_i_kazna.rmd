...
Podatke čemo podijeliti na skupove za "treniranje" i "testiranje" prema vrijednosti u stupcu "Training_Sample". Nad skupom za treniranje se radi maximum likelihood estimacija $\beta_i$, a nad skupom za testiranje testiranje modela i testira se njegova efikasnost. <br>
