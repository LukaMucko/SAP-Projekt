...
hipoteze kod Kruskal-Wallisovog testa su:

$H_0$: Medijani populacija su isti

$H_1$: Barem dva medijana nisu ista
```{r}
test <- kruskal.test(drugs ~ Education_Level, data = recidivism_full_filtered)
print(test)
```
Kruskal-Wallisovim testom opet odbacujemo nultu hipotezu zbog male p-vrijednosti.
